...
**重要提示**:
1. 始终参考标准模板 `ninebot-project/docs/templates/excel/ba_system_design_template.xlsx` 以保持结构、格式和命名约定的一致性
2. **生成的文件必须放在 `ninebot-project/docs/features/` 下的功能迭代目录中**
3. **命名规则遵循 `ninebot-project/config/publishers.yaml` 配置（naming 段）**：
...
**标准模板位置**: `ninebot-project/docs/templates/excel/ba_system_design_template.xlsx`
...
2. 检查/创建 `ninebot-project/docs/features/feature-xxx/02-designs/entities/` 目录
3. 在该目录下生成设计文件
...
读取标准模板以了解结构：
```
读取 ninebot-project/docs/templates/excel/ba_system_design_template.xlsx
```
...
确认/创建目标目录：
```
ninebot-project/docs/features/{feature_name}/02-designs/entities/
```
...
LLM: 确认功能迭代名称为 feature-customer-management
      ↓
LLM: 创建目录 ninebot-project/docs/features/feature-customer-management/02-designs/entities/
      ↓
LLM: 读取标准模板 ninebot-project/docs/templates/excel/ba_system_design_template.xlsx
      ↓
LLM: 生成文件 ninebot-project/docs/features/feature-customer-management/02-designs/entities/customer_management_entity_design.xlsx
      ↓
